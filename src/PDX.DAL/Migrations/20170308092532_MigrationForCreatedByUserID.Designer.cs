...
namespace PDX.DAL.Migrations
{
    ...
    [Migration("20170308092532_MigrationForCreatedByUserID")]
    partial class MigrationForCreatedByUserID
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("PDX.Domain.Common.PurchaseOrderStatus", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<string>("PurchaseOrderStatusCode")
                        .IsRequired()
                        .HasColumnName("purchase_order_status_code");
                    ...
                    b.ToTable("purchase_order_status","common");
                });

            modelBuilder.Entity("PDX.Domain.Common.PurchaseOrderType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.Property<string>("PurchaseOrderTypeCode")
                        .IsRequired()
                        .HasColumnName("purchase_order_type_code");
                    ...
                    b.ToTable("purchase_order_type","common");
                });
            ...
            modelBuilder.Entity("PDX.Domain.Procurement.PurchaseOrder", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("PDX.Domain.Procurement.PurchaseOrderDetail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("purchase_order_detail","procurement");
                });

            modelBuilder.Entity("PDX.Domain.Procurement.PurchaseOrderLogStatus", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.ToTable("purchase_order_log_status","procurement");
                });
            ...
            modelBuilder.Entity("PDX.Domain.Procurement.PurchaseOrder", b =>
                {
                    ...
                    b.HasOne("PDX.Domain.Common.PurchaseOrderStatus", "PurchaseOrderStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("PDX.Domain.Procurement.PurchaseOrderDetail", b =>
                {
                    ...
                    b.HasOne("PDX.Domain.Procurement.PurchaseOrder", "PurchaseOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("PDX.Domain.Procurement.PurchaseOrderLogStatus", b =>
                {
                    b.HasOne("PDX.Domain.Common.PurchaseOrderStatus", "FromPurchaseOrderStatus")
                        .WithMany()
                    ...
                    b.HasOne("PDX.Domain.Common.PurchaseOrderStatus", "ToPurchaseOrderStatus")
                        .WithMany()
